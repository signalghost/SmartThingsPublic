/**
 *  MyNextManager V3 (Service Manager)
 *  Copyright 2018-2021 Yves Racine
...
//******************   IF YOU ARE a Nest Account user, INSERT YOUR NEST ACCOUNT INFORMATION BELOW between the single quotes *******************************************************************************************************************************************
@Field String nest_user_id= ''
@Field String nest_access_token=''


//******************    IF YOU ARE Google Account user, INSERT YOUR GOOGLE ACCOUNT INFORMATION BELOW between the single quotes ******************************************************************************
...
@Field String google_cookiep1='__Secure-3PSID=7gdd1CkyioPCdgM20pjr-C1dOfnkbiFqXN79WrZfi2ClFp0gfXeEXHM3eSj3l_1tyEpmzQ.; __Secure-3PAPISID=SYXaYImkZP4hV2tC/AjPVjSG3QKL1BgHfh; NID=211=Drpi6_KJcvPA146YiVzJAst9Wo1uiJ5Ro9h30JOFzUG7GGzAsHlQ0A9uzxWuY-w3zF-26qm3HiBVr1HKN5XfGrHqm3kUpPNRuxNDdyNPC2fTuO3emf5Q3PPajTXv2e1wno1fYB-rv2eF288LY1mjM9W4rpaOLNEFfdYVR9FsgiIMbUSKzrBilIZx3Osu; __Host-3PLSID=s.youtube:7gdd1AZwwEnDgkmosb4H9Z6_zjjLtWMVKYCXhC9Wg8XfiJFHzX96vKZ0n3CibVGD1RPvsQ.; __Secure-3PSIDCC=AJi4QfGPVkb0ULhHm_j5TB4Y8zKgDcC7NQ-uMKJGF5WQwujRHUhf8aNvrbM-mxa5TWI6aQvSIw'
@Field String google_issue_token_url='https://accounts.google.com/o/oauth2/iframerpc?action=issueToken&response_type=token%20id_token&login_hint=AJDLj6LQu-SMCQLMJfOUep6S7tCeFZ7Cico3qj9toFf64MCGIQphIN0LUdL_9dsZvXZa56nzJFEiRLLKMIJVkeWcnLrksq5Gnw&client_id=733249279899-44tchle2kaa9afr5v9ov7jbuojfr9lrq.apps.googleusercontent.com&origin=https%3A%2F%2Fhome.nest.com&scope=openid%20profile%20email%20https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fnest-account&ss_domain=https%3A%2F%2Fhome.nest.com'
...
def getProtectChildName() { "My Next AlarmV3" }
def getTstatChildName() { "My Next TstatV3" }
def getCameraChildName() { "My Next CamV3" }
